...
D6.Unit = {
	...
	//2026
	defaultPriceElectricity : 32.65, //2025年値(20260403)

	// unit price yen(in Japan)/each unit
	price : {
		electricity:32.65, // override in D6.area.setPersonArea by supplier
		nightelectricity:25.24,
		sellelectricity:14.58,
		nagas:164.47,
		lpgas:758.01,
		kerosene:140.8,
		gasoline:170.2,
