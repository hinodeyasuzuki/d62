...
export class MeasureBase extends Energy {
  ...
  //calculate save cost and CO2 by each energy change, called by this.calcMeasureOne()
  calcSave() {
    //calculate CO2
    this.calcCO2();
  ...
  //
  //	in standard process, this.calcMeasures() directly call cons.calcMeasure in consumption class. 
  //
  calc() {
