...
export class ConsACheat extends ConsHTsum {
	...
	calc() {
		...
		let heatKcal = this.calcHeatLoad(this.heatSpace, this.heatTime, this.heatMonth, this.heatTemp, this.sumCons.heatMonth);
	...
	calc2nd() {
		...
		let heatKcal = this.electricity * D6.Unit.calorie.electricity * nowapf
	...
	calcMeasure() {
		...
		//not show 1st room
		let notshow1st = ( (this.subID == 1) && this.input("i2121",-1) == -1 )
