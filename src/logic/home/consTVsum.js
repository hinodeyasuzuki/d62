...
export class ConsTVsum extends ConsBase {

  //初期設定値
  constructor() {
    super();

    this.watt = 50; //electricity consumption default W
  ...
  calc2nd() {
    let electricity = this.electricity; //backup
    this.clear();

    //add each terevition
    for (let id in this.partCons) {
  ...
  */
  equip(year, size) {
    let sizeThreshold = [20, 30, 40, 50, 60, 120]; //last is maxsize
    ...
    let defEquip = {
      ...
      40: {
        ...
        2015: { pf1: 60, pf2: 90, pr1: 100000, pr2: 80000 },
        2030: { pf1: 40, pf2: 60, pr1: 80000, pr2: 70000 }
      },
      50: {
        ...
        2015: { pf1: 100, pf2: 150, pr1: 140000, pr2: 120000 },
        2030: { pf1: 70, pf2: 100, pr1: 100000, pr2: 90000 }
      },
      60: {
        1900: { pf1: 500, pf2: 700, pr1: 500000, pr2: 400000 },
        1995: { pf1: 500, pf2: 700, pr1: 500000, pr2: 400000 },
        2005: { pf1: 250, pf2: 500, pr1: 400000, pr2: 300000 },
        2015: { pf1: 140, pf2: 200, pr1: 180000, pr2: 160000 },
        2030: { pf1: 120, pf2: 180, pr1: 160000, pr2: 150000 }
      },
      120: {
        1900: { pf1: 500, pf2: 700, pr1: 500000, pr2: 400000 },
        1995: { pf1: 500, pf2: 700, pr1: 500000, pr2: 400000 },
        2005: { pf1: 350, pf2: 500, pr1: 400000, pr2: 300000 },
        2015: { pf1: 200, pf2: 300, pr1: 180000, pr2: 160000 },
